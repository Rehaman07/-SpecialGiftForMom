...
import { Zap, Footprints, AlertTriangle } from 'lucide-react';
...
export const SlipperChase: React.FC<{ onWin: () => void; onLose: () => void }> = ({ onWin, onLose }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-6 glass p-8 rounded-[40px] w-full max-w-sm relative overflow-hidden bg-rose-900/40">
      ...
      <div className="h-64 w-full relative flex items-center justify-center">
        ...
        <motion.button
          ...
          onClick={handleCatch}
          className="absolute p-4 bg-rose-500 text-white rounded-2xl shadow-[0_10px_30px_rgba(244,63,94,0.4)] border-2 border-rose-300"
        >
